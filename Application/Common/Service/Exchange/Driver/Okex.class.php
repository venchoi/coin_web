...
{
    //交易所code
    protected $exchangeCode='OKEx';
    //交易所code
    protected $exchangeName='OKEx';
    ...
    public function getCoinUnitToUsdt()
    {
        ...
        $quotationsData = $redisClient->hMget('market_tick_new_okex',$codes);
        if(!$quotationsData)
        {
            return array();
        }
    ...
    public function getQuotationsAllCodes()
    {
        ...
        $quotationsData = $redisClient->hGetAll('market_tick_new_okex');
