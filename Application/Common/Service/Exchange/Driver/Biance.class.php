...
class Biance extends Driver
{
    //交易所code
    protected $exchangeCode='Binance';
    //交易所code
    protected $exchangeName='币安';
    ...
    public function getCoinUnitToUsdt()
    {
        ...
        $quotationsData = $redisClient->hMget('market_tick_new_biance',$codes);
        if(!$quotationsData)
        {
            return array();
        }
    ...
    public function getQuotationsAllCodes()
    {
        ...
        $quotationsData = $redisClient->hGetAll('market_tick_new_biance');
